...
func (s *SmartContract) initStore(APIstub shim.ChaincodeStubInterface) sc.Response {
	store := []Store{
		Store{"凤祥园店", "唐山市路北区龙泽路与裕华道交叉口西行50米道南（裕东楼北门）", "0315", "5268016", "130203"},
		Store{"察院街店", "玉田县钰鼎春园小区104号楼", "", "18131566086", "130203"},
		Store{"复兴路店", "唐山市路南区复兴路223号", "0315", "2860826", "130203"},
		Store{"乐亭店", "乐亭永安南路（老大东方南行300米路东）", "0315", "8131897", "130203"},
...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	} else if function == "initStore" {
		return s.initStore(APIstub)
	}
